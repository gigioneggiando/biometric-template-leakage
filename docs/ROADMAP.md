...
The subsequent [raw-norm/native audit](../experiments/norm_native_audit_2026-09-18/README.md) completed genuine raw/shuffled/fixed-radius controls and all 48 follow-up paired contrasts in 254.157 seconds. Separate formulas and matcher predictions agree; identity-specific norm leakage is not established. Eight mean-pool gains and four shared-key DeepSets losses survive post-hoc correction. Closest-work comparison and attacker access are now explicit.

The package has three diagrams, fourteen result plots, [ten-slide PDF](../reports/slides/research_review.pdf), [editable PowerPoint](../reports/slides/research_review.pptx), [17-figure appendix](../reports/slides/figure_appendix.pdf) and [14-page report](../reports/Sept_Dataset_Update.pdf). Earlier studies, pilots and corrected follow-up remain separate. The 849-row / 49-artifact inventory is unchanged; 130 audit rows are separate. [Coverage gaps](../experiments/scheme_followup_2026-09-18/coverage_audit.csv), equivalence margins, learned raw-input retraining, stricter PolyProtect policies, wider confirmation and independent review remain open.
