...
The authorized MOBIO face data is prepared locally and its single-template baseline is complete. The proposed novelty claim remains untested: authorization to begin was received on 2026-09-04, but the 1/2/5/10 set construction, protocol seeds, aggregation baselines, and clustered statistical comparisons must be fixed before those runs. Exact `benchmark_cb` claims remain blocked by its unavailable source.
