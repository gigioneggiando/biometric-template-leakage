...
Available deliverables: [14-page report](../../reports/Sept_Dataset_Update.pdf), [ten-slide deck](../../reports/slides/research_review.pdf), [editable PowerPoint](../../reports/slides/research_review.pptx), [17-figure appendix](../../reports/slides/figure_appendix.pdf), and [849-row inventory](../../experiments/multiexposure_run_matrix.csv). The subsequent [raw-norm audit](../../experiments/norm_native_audit_2026-09-18/README.md) adds 130 separate audit rows, genuine raw/shuffled/fixed-radius controls and corrected failure analysis for all 48 follow-up contrasts. Identity-specific norm leakage is not established.

Broader confirmation, equivalence margins, learned raw-input retraining, stricter PolyProtect policy and independent human review remain open. Exact reproduction remains uncompleted. Historical Month 1/2 results, trained follow-up (`4352eeb`) and norm audit (`15e4384`) have separate scopes and freezes.
