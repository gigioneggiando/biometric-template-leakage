...
The [complete figure appendix](../slides/figure_appendix.pdf) collects all 15 current vector figures. The 73-condition overview covers earlier studies only; pilot and follow-up plots remain separate.
