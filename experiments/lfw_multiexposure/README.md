...
- Recurring pools: all tested pools have above-chance means. Tested pools 1/2/3/4/5/7 pass both preregistered criteria; pool 10 exceeds fresh by `21.3` points but one clustered lower bound equals chance, so it fails the interval criterion as designed. Pools 6/8/9 were not tested; failure is not equivalence.
