...
Archive checksum and acquisition steps are retained in the [SCface setup record](../../docs/setup/SCFACE_LOCAL_DATA.md). The [849-row local inventory](../multiexposure_run_matrix.csv) covers 49 artifacts but excludes SCface because its details are unavailable here. Separate [IoM-GRP/PolyProtect pilots](../scface_scheme_extension_pilot/README.md) use one model seed. The [216-endpoint follow-up](../scheme_followup_2026-09-18/README.md) and subsequent norm audit cover MOBIO/FEI only; no new SCface training or native controls were run. Existing SCface aggregates remain in the 14-page report and 17-figure appendix.
