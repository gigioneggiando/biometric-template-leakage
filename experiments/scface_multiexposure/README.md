...
Archive checksum and acquisition steps are retained in the [SCface setup record](../../docs/setup/SCFACE_LOCAL_DATA.md). The [849-row local inventory](../multiexposure_run_matrix.csv) covers 49 artifacts but excludes SCface because its details are unavailable here. Separate [IoM-GRP/PolyProtect pilots](../scface_scheme_extension_pilot/README.md) use one model seed. The [216-endpoint follow-up](../scheme_followup_2026-09-18/README.md), norm audit and [independent-pool study](../pool_replication_2026-09-19/README.md) cover MOBIO/FEI only; no new SCface training or native controls were run. Existing SCface aggregates remain supporting evidence in the 16-page report and 19-figure appendix, not matched cross-camera confirmation.
