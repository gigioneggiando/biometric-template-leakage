...
**Documentation checked: 2026-09-19. Historical Month 1 evidence retained.** MOBIO access was subsequently completed on 2026-09-04, and current multi-exposure studies cover MOBIO/LFW/FEI/SCface. The [216-endpoint scheme follow-up](../scheme_followup_2026-09-18/README.md) covers MOBIO/FEI only. See the [research package](../../reports/README.md) for the 16-page report, 19 figures and subsequent audits/pool study; the six-run LFW baseline here has not been rerun or replaced.
