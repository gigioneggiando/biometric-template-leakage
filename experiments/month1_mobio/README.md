...
This extends the prior LFW/Olivetti/CFP negative single-template result to MOBIO under identity-disjoint evaluation. It does not establish irreversibility and is not the proposed multi-exposure contribution. The next decisive experiment is the preregistered 1/2/5/10 exposure comparison under independent unseen keys.
